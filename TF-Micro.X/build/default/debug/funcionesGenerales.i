...
void config_perifericos(void)
{
    ...
    if(PORTEbits.RE0 == 0){
        ...
        EEPROM_WriteByte(9, 8);
        EEPROM_WriteByte(10, 45);
        EEPROM_WriteByte(13, 1);

        EEPROM_WriteByte(14, 0);
        EEPROM_WriteByte(15, 0);
        EEPROM_WriteByte(18, 3);
    }else{
        LCD_I2C_SetCursor(1, 0);
